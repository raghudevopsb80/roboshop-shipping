...
export PATH=$PATH:/opt/amazon-corretto-17.0.13.11.1-linux-x64/bin
/opt/amazon-corretto-17.0.13.11.1-linux-x64/bin/java -javaagent:/app/newrelic/newrelic.jar -Dnewrelic.config.license_key=${NEW_RELIC_LICENSE_KEY} -jar /app/target/shipping-1.0.jar
